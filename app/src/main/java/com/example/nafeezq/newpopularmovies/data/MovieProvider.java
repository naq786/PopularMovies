...
/**
 * Created by nafeezq on 9/26/2016.
 */
public class MovieProvider extends ContentProvider {
    ...
    public String getType(Uri uri){
        ...
        switch (match){
            case MOVIE:{
                return MovieContract.MovieEntry.CURSOR_DIR_BASE_TYPE;
            }
            case MOVIE_WITH_ID:{
                return MovieContract.MovieEntry.CURSOR_ITEM_BASE_TYPE;
            }
            default:{
    ...
    public int delete(Uri uri, String selection, String[] selectionArgs){
        ...
        switch(match){
            case MOVIE:
                ...
                break;
            case MOVIE_WITH_ID:
                numDeleted = db.delete(MovieContract.MovieEntry.TABLE_MOVIE,
                        MovieContract.MovieEntry._ID + " = ?",
                        new String[]{String.valueOf(ContentUris.parseId(uri))});
                // reset _ID
                db.execSQL("DELETE FROM SQLITE_SEQUENCE WHERE NAME = '" +
            ...
            case MOVIE:
                ...
                try{
                    for(ContentValues value : values){
                        ...
                        long _id = -1;
                        try{
                            _id = db.insertOrThrow(MovieContract.MovieEntry.TABLE_MOVIE,
                                    null, value);
    ...
    public int update(Uri uri, ContentValues contentValues, String selection, String[] selectionArgs){
        ...
        switch(sUriMatcher.match(uri)){
            case MOVIE:{
                numUpdated = db.update(MovieContract.MovieEntry.TABLE_MOVIE,
                        contentValues,
                        selection,
                        selectionArgs);
                break;
